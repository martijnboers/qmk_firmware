...
[_POKER] = LAYOUT_preonic_2x2u( \
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   UFOLD,     FOLD,      KC_DEL, \
...
[_PROGRAM] = LAYOUT_preonic_2x2u( \
  ...
  SWITCH,    KC_GRV,  KC_DLR,  KC_TILD,            KC_ASTERISK,       KC_F11,   SBOOKMARK, XXXXXXX,  KC_LBRC,  KC_RBRC, XXXXXXX,  XXXXXXX, \
...
[_EXTRA] = LAYOUT_preonic_2x2u( \
  XXXXXXX,   RESET,     EEP_RST,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   KC_MINS, KC_EQL,  XXXXXXX, XXXXXXX, XXXXXXX, \
  XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   KC_7,    KC_8,    KC_9,    XXXXXXX, XXXXXXX, \
  XXXXXXX,   XXXXXXX,   MU_TOG,    XXXXXXX,   XXXXXXX,   XXXXXXX,   HEADP,     KC_4,    KC_5,    KC_6,    KC_DEL,  XXXXXXX, \
  XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   SONG,      KC_1,    KC_2,    KC_3,    XXXXXXX, XXXXXXX, \
