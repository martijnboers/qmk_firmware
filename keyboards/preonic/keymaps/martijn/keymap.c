...
[0] = LAYOUT_preonic_2x2u( \
  ...
  KC_LCTL,   KC_LGUI, MO(3),   KC_LALT,          MO(2),   KC_SPC,           KC_RGUI, KC_DLR,  KC_PSCR, KC_LCTL
),
...
[1] = LAYOUT_preonic_2x2u( \
  ...
  KC_CAPS, KC_MPRV, KC_MPLY, KC_MNXT, KC_F5,   XXXXXXX,   XXXXXXX,   KC_PGUP,   KC_UP,     KC_PGDN,   KC_ENT,    KC_ENT, \
  KC_TRNS, SELECT,  KC_VOLD, KC_VOLU, KC_MUTE, XXXXXXX,   KC_HOME,   KC_LEFT,   KC_DOWN,   KC_RGHT,   KC_BSPC,   KC_DEL, \
  KC_LSFT, XXXXXXX, XXXXXXX, KC_C,    KC_V,    XXXXXXX,   KC_END,    XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   KC_LSFT, \
  KC_LCTL, XXXXXXX, KC_TRNS, XXXXXXX,          KC_TRNS,   KC_SPC,    XXXXXXX,              XXXXXXX,   XXXXXXX,   KC_LCTL
),
...
[2] = LAYOUT_preonic_2x2u( \
  ...
  XXXXXXX,   KC_GRV,  KC_TILD, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LCBR, KC_RCBR, XXXXXXX, XXXXXXX, \
  KC_TRNS,   KC_PLUS, KC_UNDS, KC_MINS, KC_EQL,  XXXXXXX, XXXXXXX, XXXXXXX, KC_LPRN, KC_RPRN, XXXXXXX, XXXXXXX, \
